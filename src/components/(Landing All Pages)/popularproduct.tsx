  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const data: Products[] = await fetchPopularProducts1(); // Fetch products
            ...
            >
              <Link href={`/products/${products.slug.current}`}>
                <div className="w-full h-64 overflow-hidden">
                  <Image
                    src={products.imageUrl || "/placeholder.png"} // Fallback if imageUrl is missing
